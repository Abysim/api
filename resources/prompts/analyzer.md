...
21. Найпріоритетніші правила та формат виведення:
    ...
    - Якщо виявлено незаперечні ознаки перекладу: починай з "Так.", надавай аналіз і пропонуй всі можливі виправлення як позбутися ознак перекладу, виводь лише виправлені фрагменти.
